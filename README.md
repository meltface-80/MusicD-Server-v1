...
**Current release:** v1.1.5.0 — see [`musicd/CHANGELOG.md`](musicd/CHANGELOG.md).

## Repository layout

| Path | What it is |
|------|------------|
| `musicd/` | MusicD Server (Node.js) and web client (React/Vite), v1.1.5.0 |
| `musicd-v1-1-5-0.tar` | Published release tarball — what the in-app updater downloads |
...
is over — v1.1.5.0 has the same URL as its own default, so nothing is
...
pair is carried for exactly that reason — so it will offer v1.1.5.0 and
