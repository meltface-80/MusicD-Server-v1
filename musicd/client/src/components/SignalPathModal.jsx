...
const s = {
  ...
  subtitle: { fontSize: 12, color: 'var(--text-tertiary)' },
  ...
  qualityLabel: { fontSize: 14, fontWeight: 700, marginBottom: 2 },
  qualityDesc: { fontSize: 12, color: 'var(--text-secondary)', lineHeight: 1.5 },
  empty: { padding: 40, textAlign: 'center', color: 'var(--text-tertiary)', fontSize: 14 },
  ...
  nodeTitle: { fontSize: 14, fontWeight: 700, marginBottom: 2, letterSpacing: '0.01em', display: 'flex', alignItems: 'center', gap: 8 },
  bypassTag: { fontSize: 11, fontWeight: 700, letterSpacing: '0.1em', padding: '1px 5px', borderRadius: 3, background: 'rgba(var(--tint-rgb), 0.08)', color: 'rgba(var(--tint-rgb), 0.55)' },
  passTag: { fontSize: 11, fontWeight: 700, letterSpacing: '0.1em', padding: '1px 5px', borderRadius: 3, background: 'rgba(63,208,122,0.15)', color: '#3fd07a' },
  warnNote: { fontSize: 12, color: '#f5c450', background: 'rgba(245,196,80,0.08)', border: '1px solid rgba(245,196,80,0.25)', borderRadius: 4, padding: '6px 8px', marginTop: 6, lineHeight: 1.4 },
  nodeDetail: { fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.4, marginBottom: 4 },
  metaGrid: { display: 'flex', flexWrap: 'wrap', gap: '6px 16px', marginTop: 8 },
  metaItem: {},
  metaLabel: { fontSize: 11, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--text-tertiary)', marginBottom: 1 },
