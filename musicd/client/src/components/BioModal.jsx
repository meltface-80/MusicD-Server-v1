...
const s = {
  ...
  sheet: { paddingBottom: 'var(--safe-bot)', background: 'var(--bg-surface)', borderRadius: '16px 16px 0 0', width: '100%', maxHeight: '88vh', display: 'flex', flexDirection: 'column', borderTop: '1px solid var(--border)' },
  ...
  title: { fontSize: 16, fontWeight: 700, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
  subtitle: { fontSize: 12, color: 'var(--text-tertiary)', marginTop: 2, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
  ...
  message: { padding: 28, textAlign: 'center', color: 'var(--text-tertiary)', fontSize: 14 },
  emptyTitle: { fontSize: 15, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 8 },
  ...
  attribution: { fontSize: 12, color: 'var(--text-tertiary)' },
  link: {
    display: 'inline-flex',
    alignItems: 'center',
    gap: 4,
