...
const s = {
  ...
  label: { display: 'flex', alignItems: 'center', gap: 8, color: 'var(--text-primary)', fontSize: 13, cursor: 'pointer' },
  checkbox: { width: 14, height: 14, accentColor: 'var(--accent)' },
  sliderRow: { display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0' },
  endLabel: { fontSize: 12, color: 'var(--text-tertiary)', fontFamily: 'var(--font-mono)', minWidth: 38 },
  slider: { flex: 1, height: 4, accentColor: 'var(--accent)' },
  valLabel: { fontSize: 12, color: 'var(--text-secondary)', fontFamily: 'var(--font-mono)', minWidth: 56, textAlign: 'right' },
  clipWarn: {
  ...
  errorRow: {
    fontSize: 12, color: 'var(--red)', marginTop: 4,
  },
