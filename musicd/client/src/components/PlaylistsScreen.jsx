...
const s = {
  ...
  detailMeta: { fontSize: 13, color: 'var(--jp-text-3)', padding: '0 0 10px 40px' },
  iconBtn: {
  ...
  renameInput: {
    ...
    fontSize: 15, background: 'var(--jp-bg-surface)', border: '1px solid var(--jp-border)',
    color: 'var(--jp-text)',
  },
  ...
  primaryBtn: {
    ...
    background: 'var(--jp-accent)', color: 'var(--jp-bg)', fontSize: 13, fontWeight: 700,
  ...
  ghostBtn: {
    ...
    color: 'var(--jp-text-2)', fontSize: 13, fontWeight: 600, cursor: 'pointer',
    whiteSpace: 'nowrap',
  },
  empty: { padding: '28px 6px', fontSize: 14, color: 'var(--jp-text-3)', lineHeight: 1.5 },
  ...
  trackNum: { width: 22, flexShrink: 0, fontSize: 13, color: 'var(--jp-text-3)', fontVariantNumeric: 'tabular-nums' },
  trackText: { display: 'flex', flexDirection: 'column', gap: 2, minWidth: 0, flex: 1 },
  trackTitle: { fontSize: 14, fontWeight: 600, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  trackSub: { fontSize: 12, color: 'var(--jp-text-3)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  trackDur: { fontSize: 12, color: 'var(--jp-text-3)', flexShrink: 0, fontVariantNumeric: 'tabular-nums' },
  rowRemove: {
