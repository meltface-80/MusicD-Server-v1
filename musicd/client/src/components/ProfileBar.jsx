...
const s = {
  ...
  errorX: { marginLeft: 'auto', background: 'none', border: 'none', color: '#ff8888', cursor: 'pointer', fontSize: 15, lineHeight: 1, padding: 0 },
  ...
  confirmText: { flex: 1, fontSize: 13, color: 'var(--text-primary)', minWidth: 140 },
  confirmBtn: {
    padding: '5px 10px',
    background: '#d04848',
